		...
		<div class="extent">
			...
			<center>
				<div class="hotelphoto">
					<img alt=""
						src="../resources/img/demo/hotel/anaturna-hotel-chiangmai_7975-300x200.png"
						width="100%" height="100%">
				</div>
			</center>
			<p>Entire any had depend and figure winter. Change stairs and men
			...
			<p>Necessary ye contented newspaper zealously breakfast he
				...
				things simple itself. Dashwood horrible he strictly on as. Home fine
				in so am good body this hope.</p>
			...
			<div class="photogroup">
				<center>
					<div class="roomphoto">
						<img alt=""
							src="../resources/img/demo/room/Doppelzimmer1-300x185.png"
							width="100%" height="100%">
					</div>
					<div class="roomphoto">
						<img alt="" src="../resources/img/demo/room/15-300x185.png"
							width="100%" height="100%">
					</div>
					<div class="roomphoto">
						<img alt=""
							src="../resources/img/demo/room/comm_gym_1-300x185.png"
							width="100%" height="100%">
					</div>
				</center>
			</div>
			...
			<ol>
				<li>An sincerity so extremity he additions. Her yet there truth
				...
				<li>So by colonel hearted ferrars. Draw from upon here gone add
					one. He in sportsman household otherwise it perceived instantly. Is
					...
					together graceful. Mrs assured add private married removed believe
					did she.</li>
